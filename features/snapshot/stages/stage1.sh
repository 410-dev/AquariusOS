...
python3 "{{FEATURES}}/snapshot/fstab_editor.py" "$(findmnt --output=UUID --noheadings --target=/)"
...
{{SYS_CMDS}}/preboot.sh SetNextInstallmentScript {{FEATURES}}/snapshot/stages/stage2.sh
