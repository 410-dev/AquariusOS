...
public class Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Servlet package: com.acadia.iceberg.ioserver.api.{version}
        // com.acadia.iceberg.ioserver.api.WebServlet 애노테이션을 찾은 후 그 위치에 자동 매핑
        for (String version : enabledAPIVersions) {
            Set<Class<?>> servletClasses = new Reflections("com.acadia.iceberg.ioserver.api." + version).getTypesAnnotatedWith(WebServlet.class);
    ...
    private static void buildTables() throws Exception {
        ...
        // Enumerate all class under com.acadia.iceberg.ioserver.records
        // Then, call buildTable() method of each class
        Set<Class<? extends DatabaseRecord>> classes = new Reflections("com.acadia.iceberg.ioserver.records").getSubTypesOf(DatabaseRecord.class);
